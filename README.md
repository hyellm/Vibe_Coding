...
- **시설 화면**: 장비 목록에서 해금·업그레이드 버튼 직접 탭, 상세 오버레이 제공
- **알바넷 시스템**: 장비별 알바생 최대 5명 고용(치즈 소비), 알바생 1명당 생산량 +100%
- **직원 시스템**: 장비 설치 시 기본 직원(베이스 워커) 자동 배치, 알바넷 고용 시 추가 직원 등장
- **레시피 화면**: 보유 장비 기반 해금, 드립 커피·에스프레소·아메리카노 정보 열람
- 미션 7개 (손님 서빙·장비 설치·업그레이드·직원 채용) 단계별 ❤️ 하트 보상
- localStorage 자동저장 + 오프라인 보상(최대 8시간)
- Zustand + persist로 상태 관리, Framer Motion 애니메이션

**→** [03_TinyCafe_Playable/](03_TinyCafe_Playable/) · **🔗 라이브 플레이:** https://tinycafe-five.vercel.app
