...
실시간 JPY → KRW 환율을 조회하고 최근 7일 변동 그래프를 보여주는 정적 웹페이지입니다.
...
- 이동 경로 점선 표시, 최고 기록 저장(AsyncStorage)

**폴더:** [02_MazeEscape/](02_MazeEscape/)

---

## 03 TinyCafe Playable — 카페 아이들 게임
...
**폴더:** [03_TinyCafe_Playable/](03_TinyCafe_Playable/)
